...
module.exports = Dhani = async (Dhani, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6289678916536@s.whatsapp.net`]
...
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'ᴍᴇɴᴜ' }, type: 1 },{ buttonId: `${prefix}sewabot`, buttonText: { displayText: '𝓐𝓐💗' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [senderr,pemilik]}}}, 'buttonsMessage')
...
{buttonId:`${prefix}rules`,buttonText:{displayText:'𝓐𝓐'},type:1}
]
...
reply(`${err}`)
	...
	Dhani.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer DhaniGans",body:"Jangan Lupa Subscribe Bot Dhani ?",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dhani.jpg'),sourceUrl:"https://wa.me/6289678916536"}}})
        }
	// console.log(e)
	}
}
